...
import com.jaky.myplayer.config.VP;
import com.jaky.myplayer.util.PreferenceUtils;
import com.jaky.myplayer.ui.view.MediaController;
import com.jaky.myplayer.service.PlayerService;
import com.jaky.myplayer.ui.view.VideoView;
import com.jaky.myplayer.util.ApplicationUtils;
import com.jaky.myplayer.util.DeviceUtils;
import com.jaky.myplayer.util.ImageUtils;
import com.jaky.myplayer.util.IntentHelper;
import com.jaky.myplayer.util.MediaUtils;
import com.jaky.myplayer.util.StringUtils;
import com.jaky.myplayer.util.ToastUtils;
...
public class VideoActivity extends Activity implements
	...
	public void snapshot() {
		if (!com.jaky.myplayer.util.FileUtils.sdAvailable()) {
