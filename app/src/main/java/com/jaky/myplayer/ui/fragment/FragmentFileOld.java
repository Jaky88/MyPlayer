package com.jaky.myplayer.ui.fragment;
...
import com.jaky.myplayer.helper.FileBusiness;
...
import com.jaky.myplayer.ui.activity.MainActivity;
import com.jaky.myplayer.ui.adapter.ArrayAdapter;
import com.jaky.myplayer.network.FileDownloadHelper;
import com.jaky.myplayer.ui.activity.VideoActivity;
...
public class FragmentFileOld extends FragmentBase implements
		OnItemClickListener, MediaScannerService.IMediaScannerObserver {
	...
	private ServiceConnection mMediaScannerServiceConnection = new ServiceConnection() {
		...
		public void onServiceConnected(ComponentName name, IBinder service) {
			mMediaScannerService = ((MediaScannerService.MediaScannerServiceBinder) service)
					.getService();
